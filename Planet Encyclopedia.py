...
def PlanetInfo():
    ...
    if planet == "Mercury":
        ...
        label_planet_info['text'] = "Mercury is the smallest planet in the Solar System. It is just a little bigger than the Earth's moon"
    elif planet == "Venus":
        label_planet_name['text'] = "Venus"
        label_planet_image['image'] = Venus
        label_planet_gravity_radius['text'] = "Gravity: 8.87 m/s² \n Radius : 6,051.8 km"
        label_planet_info['text'] = "Venus is the brightest object in the sky, next to, Sun and Moon. It can sometimes be seen like a star in the morning or evening sky"
    elif planet == "Earth":
        label_planet_name['text'] = "Earth"
        label_planet_image['image'] = Earth
        label_planet_gravity_radius['text'] = "Gravity: 9.807 m/s² \n Radius : 6,371 km"
        label_planet_info['text'] = "It is the only known planet to contain life. It is also the only known planet with liquid surface water"
